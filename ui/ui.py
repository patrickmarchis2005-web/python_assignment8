...
class Ui():
    def __init__(self, student_service: StudentService, discipline_service: DisciplineService, grade_service: GradeService):
                ...
                if option[1] == "1": # Remove a student
                    while True:
                        try:
                            ...
                            print("\nInvalid option. Try again\n")
                    try:
                        # self.__student_service.remove(stud_id)
                ...
                if option[1] == "1": # Update a student
                    ...
                    while True:
                        try:
                            ...
                            print("\nInvalid option. Try again\n")
                    try:
                        self.__discipline_service.update_name(new_name=new_name, discipline_id=discipline_id)
                    except EmptyRepositoryError:
                        print("\nThe repository is empty and cannot do this operation\n")
                    except IDNotFoundError:
                        print("\nThe discipline's ID does not exist\n")
                    ...
                    while True:
                        try:
                            ...
                            print("\nInvalid option. Try again\n")
                    old_grade = Grade(student_id=student_id, discipline_id=discipline_id, grade_value=old_value)
                    try:
